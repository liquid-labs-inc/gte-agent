...
export const SessionTable = sqliteTable(
  "session",
  {
    ...
    principal_id: text()
      .$type<GTEAuth.PrincipalID>()
      .notNull()
      .$default(() => GTEAuth.DEV_PRINCIPAL_ID),
    authority_id: text()
      .$type<GTEAuth.AuthorityID>()
      .notNull()
      .$default(() => GTEAuth.DEV_AUTHORITY_ID),
  ...
  (table) => [
    ...
    index("session_principal_idx").on(table.principal_id),
    index("session_authority_idx").on(table.authority_id),
