import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@gte-agent/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
