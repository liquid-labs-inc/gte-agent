...
export const TypeId: TypeId = "~@gte-agent/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@gte-agent/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@gte-agent/effect-sqlite-node/NodeSqliteClient")
